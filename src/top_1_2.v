...
//   MCU can read back any of those addresses at any time, plus the live PC at
//   0x3008, with a repeated-START I2C read (see mmio_decoder, i2c_slave_mmio).
module top(
    input  clk,
    input  rst,
    input  scl,
    input  sda_in,      // was: inout sda
    output sda_out,     // NEW
    output sda_oe,      // NEW
    output reg led
);
    ...
    // ================================================================
    // INTEGRATED LOGIC ANALYZER (ILA) DEBUG INSTANTIATION
    // ================================================================
//    ila_0 ILA_inst (
//        .clk(clk),                  // System Clock
//        .probe0(PC_out),            // [31:0] Current Program Counter
//        .probe1(mmio_wr),           // [0:0]  I2C MMIO Write Strobe
//        .probe2(mmio_addr),         // [15:0] Target MMIO Address
//        .probe3(mmio_wdata),        // [31:0] Written Data Value
//        .probe4(csr),               // [7:0]  Control & Status Register
//        .probe5(target_pc),         // [31:0] Execution Target Breakpoint
//        .probe6(done)               // [0:0]  Execution Completion Flag
//    );
endmodule